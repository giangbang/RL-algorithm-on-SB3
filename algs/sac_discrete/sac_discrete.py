...
from .policies import MlpPolicy, DiscreteSACPolicy
...
class DiscreteSAC(OffPolicyAlgorithm):
    ...
    This implementation mostly based on the Sac continuous version from Stable baselines3
    """
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            if self.ent_coef_optimizer is not None:
                ...
                with th.no_grad():
                    entropy = self.actor.get_distribution(
            ...
            with th.no_grad():
                ...
                next_action_probs, next_entropy = self.actor.action_log_prob(
                ...
                next_q_values = (next_q_values * next_action_probs).sum(
                    dim=1, keepdims=True
                )
                # add entropy term
